...
public abstract class AbstractBETransmitterDeprecated extends AbstractBEAntennaDeprecated implements ITransmitterAntenna {

    private final Set<INetConnection> receivers;

    public <T extends S0Block> AbstractBETransmitterDeprecated(BlockEntityType<?> type, BlockPos pos, BlockState state) {
