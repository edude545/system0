...
public class DebugMachine extends S0Machine {
    ...
    public @Nullable BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new net.ethobat.system0.machinery.DebugMachine.BE(pos, state);
    }

    @Override
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return net.ethobat.system0.machinery.DebugMachine.BE::tick;
    }
    ...
    //        }
            net.ethobat.system0.machinery.DebugMachine.BE be_ = (net.ethobat.system0.machinery.DebugMachine.BE) be;
            be_.syncScreenData();
            if (!world.isClient()) {
...
//                }
        ...
        public @Nullable ScreenHandler createMenu(int syncId, PlayerInventory playerInv, PlayerEntity player) {
            return new net.ethobat.system0.machinery.DebugMachine.SH(syncId, playerInv, this);
        }
...
//        }
    ...
    public static class HS extends S0Machine.HS<net.ethobat.system0.machinery.DebugMachine.SH> {

        public HS(net.ethobat.system0.machinery.DebugMachine.SH handler, PlayerInventory inventory, Text title) {
