...
public final class S0Items {
    ...
    static {
        Crafting.INDIGONITE_COMPOSITE.giveTooltip();
        Crafting.GLAUCOUS_GOURD_SLICE.giveTooltip();
        Crafting.FLASHTIN_ANTENNA.giveTooltip();
        Crafting.SYMVINYL_SHEET.giveTooltip();
        Crafting.PARA_TRILLIONS.giveTooltip();
        Crafting.NEXXINE_SYMBOL.giveTooltip();

        S0Registrar.register(Components.ORGIMEX_DUAL_CELL, "orgimex_dual_cell");
    }
