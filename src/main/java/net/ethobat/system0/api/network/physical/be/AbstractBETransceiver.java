...
public abstract class AbstractBETransceiver extends AbstractBEAntenna implements ITransceiverAntenna {

    private final Set<INetConnection> transmitters;
    private final Set<INetConnection> receivers;

    public <T extends S0Block> AbstractBETransceiver(BlockEntityType<?> type, BlockPos pos, BlockState state) {
